  ...
  return (
    <>
      <section className='bg-[#0a0908] w-full text-center pt-[7.5rem]'>
        <p className='text-[2rem]'>Hey! I'm <span className='text-[#a97da9]'>Nida Danish</span></p>

        <p className='text-[2rem]'><span className='text-[#a97da9]'>I</span>'m <span className='text-[#a97da9]'>A F</span>ront <span className='text-[#a97da9]'>E</span>nd <span className='text-[#a97da9]'>W</span>eb <span className='text-[#a97da9]'>D</span>eveloper</p>

        <p className='mt-[1.25rem] mb-[2rem] text-[1.125rem] '>I can build user interface for web sites and applications with <span className='text-[#a97da9]'>React JS</span> and <span className='text-[#a97da9]'>Next.Js</span><br />I love the front end development.</p>

        <Button textName={"Hire Me"}/>

        <div className='mt-[3.125rem] m-auto sm:w-[60%] lg:w-[30%] lg:px-[1.5rem] py-1 flex gap-[3.125rem] justify-center items-center lg:h-[52px] bg-[#a97da9] rounded-full'>
